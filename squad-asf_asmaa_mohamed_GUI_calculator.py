...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.minusorplusButton = QtWidgets.QPushButton(self.centralwidget, clicked=lambda:self.plus_minus_it())
        self.minusorplusButton.setGeometry(QtCore.QRect(10, 470, 75, 75))
        font = QtGui.QFont()
        font.setPointSize(26)
        self.minusorplusButton.setFont(font)
        self.minusorplusButton.setObjectName("minusorplusButton")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.minusorplusButton.setText(_translate("MainWindow", "+/-"))
